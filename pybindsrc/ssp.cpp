...
register_ssp(py::module& m)
{
  ...
  py::class_<MillisliceHeader>(m, "MillisliceHeader")
    ...
    .def_property_readonly("triggerTime",
                           [](const MillisliceHeader& self) -> unsigned long { return self.triggerTime; })
    ...
    .def_property_readonly_static("sizeInUInts",
                                  [](const MillisliceHeader& self) -> size_t { return self.sizeInUInts; });
