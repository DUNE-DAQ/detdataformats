...
register_daphne(py::module& m)
{
  ...
  py::class_<DAPHNEFrame::Header>(m, "DAPHNEHeader")
    ...
    .def_property_readonly("trigger_peak_height",
                           [](DAPHNEFrame::Header& self) -> uint32_t { return self.trigger_peak_height; })
    .def_property_readonly("wf_length_in_words",
                           [](DAPHNEFrame::Header& self) -> uint32_t { return self.wf_length_in_words; })
  ...
  py::class_<DAPHNEStreamFrame>(m, "DAPHNEStreamFrame", py::buffer_protocol())
    ...
    .def(
      "get_daqheader",
      [](DAPHNEStreamFrame& self) -> const DAQHeader& { return self.daq_header; },
    ...
    .def(
      "get_trailer",
      [](DAPHNEStreamFrame& self) -> const DAPHNEStreamFrame::Trailer& { return self.trailer; },
      py::return_value_policy::reference_internal)
