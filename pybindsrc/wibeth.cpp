...
register_wibeth(py::module& m)
{
  ...
  py::class_<WIBEthFrame::WIBHeader>(m, "WIBHeader")
    ...
    .def_property(
      ...
      [](WIBEthFrame::WIBHeader& self, uint32_t colddata_timestamp_0) {
  ...
  py::class_<WIBEthFrame>(m, "WIBEthFrame", py::buffer_protocol())
    ...
    .def(
      "get_daqheader",
      [](WIBEthFrame& self) -> const DAQEthHeader& { return self.daq_header; },
      py::return_value_policy::reference_internal)
    .def(
      "get_wibheader",
      [](WIBEthFrame& self) -> const WIBEthFrame::WIBHeader& { return self.header; },
      py::return_value_policy::reference_internal)
    ...
    .def("get_bytes",
         [](WIBEthFrame* fr) -> py::bytes { return py::bytes(reinterpret_cast<char*>(fr), sizeof(WIBEthFrame)); });
}
