...
register_trigger_primitive(py::module& m)
{
  ...
  py::class_<TriggerPrimitive>(m, "TriggerPrimitive", py::buffer_protocol())
    ...
    .def_property_readonly("time_over_threshold",
                           [](TriggerPrimitive& self) -> uint64_t { return self.time_over_threshold; })
    ...
    .def_property_readonly("algorithm",
                           [](TriggerPrimitive& self) -> TriggerPrimitive::Algorithm { return self.algorithm; })
