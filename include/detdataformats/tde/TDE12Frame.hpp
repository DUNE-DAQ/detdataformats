...
{
  return o << "version: " << unsigned(tde12header.version) << " det_id: " << unsigned(tde12header.det_id)
           << " crate: " << unsigned(tde12header.crate) << " slot: " << unsigned(tde12header.slot)
           << " link: " << unsigned(tde12header.link) << "timestamp: " << tde12header.get_timestamp()
           << "TAItime: " << tde12header.get_TAItime() << "tde_header: " << unsigned(tde12header.tde_header)
           << " tde_errors: " << unsigned(tde12header.tde_errors) << '\n';
}
