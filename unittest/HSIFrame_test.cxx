...
BOOST_AUTO_TEST_CASE(TimestampRoundTrip)
{
  ...
  const std::vector<uint64_t> test_timestamps = { 0,
                                                  1,
                                                  0xFF,
...
{
  HSIFrame frame = make_frame(5,                  // version
                              3,                  // detector_id
                              7,                  // crate
                              2,                  // slot
                              42,                 // link
...
BOOST_AUTO_TEST_CASE(ByteRoundTrip)
{
  ...
  HSIFrame original = make_frame(5, 3, 7, 2, 42, 0x0123456789ABCDEF, 0x11111111, 0x22222222, 0x33333333, 0x44444444);
